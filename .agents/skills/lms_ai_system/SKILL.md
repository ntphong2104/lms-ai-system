---
name: lms-ai-system
description: Quy tắc phát triển và vận hành hệ thống LMS AI tích hợp Trợ lý học tập (FastAPI, Qdrant, Redis, Sentry, SQLAlchemy Connection Pool)
---

# BỘ QUY TẮC PHÁT TRIỂN HỆ THỐNG LMS AI
